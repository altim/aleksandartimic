...
console.log(`${Key}Stack: ${Value}React, Backbone, Vanilla JS, jQuery, Underscore, Handlebars, SASS, Python, PHP, MySQL, Jenkins, Grunt, Gulp, Docker, Twitter Bootstrap, Gitlab, BASH shell scripting`)
console.log(`\n`)
